...
## Corpus Check
- 22 files · ~10,630 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 237 nodes · 462 edges · 12 communities (11 shown, 1 thin omitted)
...
Cohesion: 0.15
Nodes (31): diff_post(), DiffResult, EnrichedPost, PreviousListen, SourcePost, Track, TrackSummary, derive_avg_track_ms() (+23 more)

### Community 1 - "WordPress API & Auth"
Cohesion: 0.12
Nodes (23): Transport Probe Gate, _auth_header helper, _resolve_taxonomy_updates helper, auth_header_for_apply(), build_basic_auth_header(), ensure_https(), fetch_posts_page(), probe_wordpress_api() (+15 more)
...
Cohesion: 0.15
Nodes (28): build_enriched_post(), _full_durations(), listen_event_date_update(), match_metadata_update(), _optional_str(), release_date_update(), _rows(), spotify_album_url_update() (+20 more)
...
Cohesion: 0.12
Nodes (16): Dry-run By Default, Idempotent Write Discipline, One-time Backfill Model, Preserve Relisten and Unreleased, Execution Handoff, File Structure, Global Constraints, Self-Review (+8 more)
...
Cohesion: 0.29
Nodes (6): Apply, Dry Run, Environment, Setup, Tests, Wordpress-PostToAlbum-Script
...
## Knowledge Gaps
- **68 isolated node(s):** `Response`, `Setup`, `Environment`, `Dry Run`, `Apply` (+63 more)
...
- **Should `Last.fm Enrichment` be split into smaller, more focused modules?**
